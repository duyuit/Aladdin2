...
Entity::CollisionReturn GameCollision::RecteAndRect(RECT rect1, RECT rect2) //Trả về vùng va chạm
{
...
bool GameCollision::isCollide(RECT rect1, RECT rect2) //Kiểm tra va chạm 2 RECT
{
...
Entity::SideCollisions GameCollision::getSideCollision(Entity *e1, Entity::CollisionReturn data)
{
    ...
    D3DXVECTOR2 cCenter = D3DXVECTOR2(xCenter, yCenter);//Tâm của vùng va chạm
    D3DXVECTOR2 eCenter = e1->GetCenter(); //Tâm của Entity e1
