...
DemoScene::~DemoScene()
{
	//delete Bowl1, Bowl2, enemy1, enemy2, enemy3, enemy4;

	/*vector<Entity*> abc;
	mMap->GetQuadTree()->getAllEntities(abc);
...
#pragma endregion
	...
	if (tag == Entity::string || tag == Entity::BrickDrop || tag==Entity::Bung || tag == Entity::stair) return;
